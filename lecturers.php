...
<body class=''>
    ...
    <span class="text-success">LECTURER LOGIN</span>
  </a>
        ...
        <div style="width:400px;">
                        ...
                        <form class="px-4 py-3">
                           <div class="form-group">
                              ...
                              <input type="email" class="form-control" id="emaill" placeholder="email@example.com">
                           </div>
                           <div class="form-group">
                          ...
                          <input type="Submit" class="bn btn-success" id="loginl" value="Login">
                        </form>
