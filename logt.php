...
<body class='c'>
    ...
    <span class="text-success">RL Agents</span>
  </a>
                ...
                <div class="collapse navbar-collapse float-md-right" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item active">
                            <a class="nav-link" href="index.php"><span class="text-success">Home</span><span class="sr-only">(current)</span></a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="about.php"><span class="text-success">About Us</span></a>
                        </li>
        ...
        <div style="width:400px;">
                        ...
                        <form class="px-4 py-3">
                           <div class="form-group">
                              <label for="exampleDropdownFormEmail1" style="color:Plum;">Email address</label>
                           ...
                           <div class="form-check">
                              ...
                              <label class="form-check-label" for="dropdownCheck" style="color:Plum;">
                              Remember me
                              </label>
                          </div>
...
<hr>
<!-- Rights-->
<p class="rights b" style="color:Plum;"><span>©  </span><span class="copyright-year">2018</span><span> </span><span>Kenya</span><span>. </span><span>All Rights Reserved.</span></p>
  </div>
  <div class='col-md-1'></div>
</div>
