...
<body class=''>
    ...
    <span class="text-success">COD LOGIN</span>
  </a>
        ...
        <div style="width:400px;">
                        ...
                        <form class="px-4 py-3">
                           <div class="form-group">
                              <label for="exampleDropdownFormEmail1" style="color:Plum;">Email</label>
                              <input type="email" class="form-control" id="emailc" placeholder="email@example.com">
                           </div>
                           <div class="form-group">
                          ...
                          <input type="Submit" class="bn btn-success" id="loginc" value="Login">
                        </form>
